...
/datum/component/storage
	...
	var/obj/screen/storage/close/closer						//close button object
...
/datum/component/storage/Initialize(datum/component/storage/concrete/master)
	...
	RegisterSignal(parent, COMSIG_ATOM_EMP_ACT, .proc/i_emp_act)
...
/datum/component/storage/proc/i_emp_act(datum/source, severity)
	// SIGNAL_HANDLER
...
/datum/component/storage/proc/on_attack_hand(datum/source, mob/user)
	...
	if(user.active_storage == src && A.loc == user) //if you're already looking inside the storage item
		...
		close(user)
		. = COMPONENT_NO_ATTACK_HAND //COMPONENT_CANCEL_ATTACK_CHAIN
		return
