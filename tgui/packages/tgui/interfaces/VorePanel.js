  ...
  return (
    <Fragment>
      ...
      {(tabIndex === 0 && (
        ...
        (tabIndex === 2 && <VoreContentsPanel outside contents={contents} />) ||
        (tabIndex === 3 && (
          <Section
      ...
      <Flex spacing={1} wrap="wrap" justify="center">
        <Flex.Item basis="33%">
          <Button
            ...
            fluid
            tooltip={
              'This button is to toggle your ability to be devoured by others. ' +
              (devourable
                ? 'Click here to prevent being devoured.'
                : 'Click here to allow being devoured.')
            }
        ...
        <Flex.Item basis="33%">
          <Button
            ...
            fluid
            tooltip={
              "This button is for those who don't like being eaten by mobs. " +
              (allowmobvore
            ...
            content={
              allowmobvore ? 'Mobs eating you allowed' : 'No Mobs eating you'
            }
          />
        </Flex.Item>
        <Flex.Item basis="33%" grow={1}>
          <Button
            ...
            fluid
            tooltip={
              'This button is to toggle your ability to be fed to or by others vorishly. ' +
              (feeding
        ...
        <Flex.Item basis="50%">
          <Button
            ...
            fluid
            tooltip={
              "This button is for those who don't like being digested. It can make you undigestable." +
              (digestable
                ? ' Click here to prevent digestion.'
                : ' Click here to allow digestion.')
            }
            tooltipPosition="bottom-start"
        ...
        <Flex.Item basis="50%">
          <Button
            ...
            fluid
            tooltip={
              "This button allows preds to know whether you prefer or don't prefer to be absorbed. " +
              (absorbable
                ? 'Click here to disallow being absorbed.'
                : 'Click here to allow being absorbed.')
            }
        ...
        <Flex.Item basis="50%">
          <Button
            ...
            fluid
            tooltip={
              'Be able to hear vore sounds. ' +
              (vore_sounds
                ? 'Click here to turn off vore sounds.'
                : 'Click here to turn on vore sounds.')
            }
            content={
              vore_sounds ? 'Vore Sounds Enabled' : 'Vore Sounds Disabled'
            }
          />
        </Flex.Item>
        <Flex.Item basis="50%">
          <Button
            ...
            fluid
            tooltip={
              'Be able to hear digestion sounds. ' +
              (digestion_sounds
            ...
            content={
              digestion_sounds
                ? 'Digestion Sounds Enabled'
                : 'Digestion Sounds Disabled'
            }
          />
        </Flex.Item>
        <Flex.Item basis="25%">
          <Button
            ...
            fluid
            tooltip={
              'Be able to be licked by others. ' +
              (lickable
        ...
        <Flex.Item basis="25%">
          <Button
            ...
            fluid
            tooltip={
              'Be able to be smelled by others. ' +
              (smellable
