...
export const Limbgrower = (props, context) => {
  ...
  return (
    <Window title="Limb Grower" width={500} height={760}>
      {!!busy && (
        ...
        <Section
          ...
          {disk['name'] ? (
            <div>
              ...
              Attempting to create genitalia will use the disk&apos;s data. Any
              Synthetic Frameworks created will overwrite the race category
              selected.
            </div>
          ) : disk['disk'] ? (
            'No data.'
