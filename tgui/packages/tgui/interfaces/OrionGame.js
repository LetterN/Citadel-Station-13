      ...
      <Stack.Item>
        <Section title="Status Example" fill>
          <Stack mb={-1} fill>
            ...
            <Divider vertical />
            <Stack.Item grow>
              This is the status panel for your pioneers. Each one requires 1
              food every time you continue towards{' '}
              <span style={goodstyle}>Orion</span>. You can find more crew on
              your journey, and lose them as fast as you found &apos;em.
              <br />
              <br />
...
export const OrionGame = (props, context) => {
  ...
  return (
    <Window title={gamename} width={400} height={500}>
      <Window.Content>
