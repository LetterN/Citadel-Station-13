          ...
          {!docked_location ? (
            <Modal
              ...
              <Flex>
                ...
                <Flex.Item mt={5} ml={2} color="yellow">
              ...
              <Section title="Info">
                <LabeledList>
                  ...
                  <LabeledList.Item label="Engine Force">
                    {engine_force}Kn ({engines} engine
                    {engines !== 1 ? 's' : null})
                  </LabeledList.Item>
                  <LabeledList.Item label="Sublight speed">
                    {calculated_speed}ms{<sup>-1</sup>}{' '}
                    {calculated_speed < 1 ? (
                      <Tooltip content="INSUFFICIENT ENGINE POWER">
                  ...
                  {calculated_non_operational_thrusters.len ? (
                    <LabeledList.Item label="Warning">
                      {calculated_non_operational_thrusters} thruster
                      {calculated_non_operational_thrusters !== 1
                        ? 's are'
                        : ' is'}{' '}
                      not operational.
                    </LabeledList.Item>
                  ...
                  <LabeledList.Item label="Fuel Consumption">
                    {calculated_consumption} unit
                    {calculated_consumption !== 1 ? 's' : null} per travel
                  </LabeledList.Item>
